roteiro = {
    ...
    Pav1 = {
        ...
        {speaker = "Berri", text = "Fiquem sossegados, eu já cuidei deles e estão todos a salvo."},
        {speaker = "Henrique Gabigol", text = "If Berri == True IAs recebem morte."},
        {speaker = "Fofinho", text = "Obrigado professor. Isso me lembra a revolta das máquinas agrícolas que ocorreu na minha cidade no ano de 2012. Eu fui o líder que salvou a cidade."},
        {speaker = "Tiago R.A.", text = "Muito obrigado Rafael. Graças a você tenho mais uma coisa pra eu colocar no meu currículo hehehe."},
        ...
        {speaker = "Vagner", text = "Finalmente consegui te alcançar. Meus contatos no C3 disseram que as máquinas fizeram uma base na reitoria. Me disseram que elas estão sendo controladas por um super dispositivo que está lá."},
    ...
    biblioteca = {
        ...
        {speaker = "Berri", text = "Aparentemente o Vagner tinha razão. Aquele livro realmente pode me ajudar. Você sabe sobre o livro 'LIVRO' moça?"},
        ...
        {speaker = "Berri", text = "Boa, era disso que eu precisava! Agora posso ir para a reitoria acabar com isso tudo!"},
        ...
        {speaker = "Vagner", text = "Eu sei o quanto o 'BOSS' importava pra você. Mas é o momento de finalizar isso tudo! Você precisa ir para a Reitoria e enfrentar o 'BOSS' e salvar a FURG. O futuro da FURG está nas suas mãos, Berri."},
